...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('pk',),
                'permissions': (('view_vanleaderprimnew', 'Mövcud vanleader primlərə baxa bilər'), ('add_vanleaderprimnew', 'Vanleader prim əlavə edə bilər'), ('change_vanleaderprimnew', 'Vanleader prim məlumatlarını yeniləyə bilər'), ('delete_vanleaderprimnew', 'Vanleader prim silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
